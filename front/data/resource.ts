export default [
  {
    ...
    list: [
      ...
      },
      {
        ...
        description: '30 天 JavaScript 编程挑战。该教程虽然是英文教程但是图文并茂通俗易通，内容循序渐进包含练习题，适合零基础想要学习 JavaScript 的同学',
        url: 'https://github.com/Asabeneh/30-Days-Of-JavaScript',
      },
      {
        title: 'YesPlayMusic',
        description: '高颜值的第三方网易云播放器。它不仅拥有简洁美观的外观，还有丰富的功能',
      ...
      {
        title: 'spy-debugger',
        description: '远程调试手机页面和抓包的工具。操作简单仅需手机和电脑在同一个 WIFI 下，即可在实现真机调试页面',
        url: 'https://github.com/wuchangming/spy-debugger',
      },
      {
        title: 'nanoid',
        description: '用于生成随机 ID 的 JS 库',
        url: 'https://github.com/ai/nanoid',
      },
      {
        title: 'nexe',
        description: '可将 Node.js 应用程序，打包成一个可执行文件的命令行工具',
        url: 'https://github.com/nexe/nexe',
      },
      {
        title: 'rough',
        description: '手绘风格的图形库。可以让你用素描、类似手绘的风格来绘制图形',
        url: 'https://github.com/rough-stuff/rough',
      },
      {
        title: 'cnchar',
        description: '小巧的汉字处理 JS 库。支持简体字拼音、多音字、笔画数等功能',
      ...
      },
      {
        ...
        url: 'https://github.com/hua1995116/react-resume-site',
      },
      {
        title: '后台数据管理系统',
        description:
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        path: 'HTML5移动Web开发指南.pdf',
      },
      {
        title: '精通CSS：高级Web标准解决方案.pdf',
        path: '精通CSS：高级Web标准解决方案.pdf',
      },
      {
        title: 'flexbox-cheat-sheet.pdf',
        path: 'flexbox-cheat-sheet.pdf',
      },
      {
        title: 'Git-branching-model.pdf',
        path: 'Git-branching-model.pdf',
      },
      {
        title: 'github-git-cheat-sheet.pdf',
        path: 'github-git-cheat-sheet.pdf',
      },
      {
        title: 'React 学习之道.pdf',
        path: 'React 学习之道.pdf',
      },
      {
        title: 'react-cheatsheet.pdf',
        path: 'react-cheatsheet.pdf',
      },
      {
        title: 'Web开发权威指南.pdf',
        path: 'Web开发权威指南.pdf',
