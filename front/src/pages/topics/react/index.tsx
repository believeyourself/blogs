      ...
      <Space direction="vertical" className={styles.content}>
        <AntCard title="React 基础文档">
          <div className={styles.doc}>
            <a target="_blank" href="https://zh-hans.reactjs.org/" rel="nofollow">
              React
            </a>
        ...
        <AntCard title="Redux 中间件">
          <div className={styles.doc}>
              <a
                target="_blank"
                href="https://redux-saga-in-chinese.js.org/" rel="nofollow"
              >
                redux-saga
              </a>
              ...
              <a target="_blank" href="https://github.com/reduxjs/redux-thunk" rel="nofollow">
                redux-thunk
              </a>
        ...
        <AntCard title="Redux 脚手架">
          <div className={styles.doc}>
              <a
                target="_blank"
                href="https://create-react-app.dev/docs/getting-started" rel="nofollow"
              >
                create-react-app
              </a>
              <a target="_blank" href="https://umijs.org/zh-CN/docs" rel="nofollow">
                umi
              </a>
              
            <a target="_blank" href="https://remix.run/docs/en/v1" rel="nofollow">
              remix
            </a>
            </div>
        </AntCard>
        <AntCard title="React UI库">
          <div className={styles.doc}>
            ...
            <a target="_blank" href="https://mui.com/zh/getting-started/installation/" rel="nofollow">
              Material-UI
            </a>
            <a target="_blank" href="https://react-bootstrap.github.io/getting-started/introduction" rel="nofollow">
              react-bootstrap
            </a>
          </div>
        </AntCard>
